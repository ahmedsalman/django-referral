...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['name']
        db.delete_unique(u'referral_campaign', ['name'])

        # Adding field 'Campaign.slug'
        db.add_column(u'referral_campaign', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2016, 3, 28, 0, 0), unique=True, max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'referral_campaign', 'slug')

        # Adding unique constraint on 'Campaign', fields ['name']
        db.create_unique(u'referral_campaign', ['name'])
