...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.page'
        db.add_column(u'referral_campaign', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='campaign_pages', to=orm['pages.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.page'
        db.delete_column(u'referral_campaign', 'page_id')
    ...
    models = {
        ...
        u'referral.campaign': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'campaign_pages'", 'to': u"orm['pages.Page']"}),
