...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Referrer.creation_date'
        db.delete_column(u'referral_referrer', 'creation_date')


    def backwards(self, orm):
        # Adding field 'Referrer.creation_date'
        db.add_column(u'referral_referrer', 'creation_date',
