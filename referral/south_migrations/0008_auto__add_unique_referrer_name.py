...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Referrer', fields ['name']
        db.create_unique(u'referral_referrer', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Referrer', fields ['name']
        db.delete_unique(u'referral_referrer', ['name'])
